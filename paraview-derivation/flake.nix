{
  ...
  in {
    packages.${system}.default = paraview.overrideAttrs (oldAttrs: {
      
      # Modify postPatch - run original first, then add your changes
      postPatch = ''
        # We will build paraview with internal vtk, so the following lines have to go:
        #
      ...
      nativeBuildInputs = oldAttrs.nativeBuildInputs ++ [
        ...
        pkgs.uv
                                                        ...
                                                        # we do not use vtk-full that is external vtk
      propagatedBuildInputs = (pkgs.lib.filter (p: p != pkgs.vtk-full) oldAttrs.propagatedBuildInputs) ++ [
        ...
        #
        ###########################
        # error: Cannot build '/nix/store/3aa51qpwg2z6cvxapv961r2z1sjgd8w8-paraview-6.0.1.drv'.
        # Reason: builder failed with exit code 1.
        # Output paths:
        #   /nix/store/s8zf2l774mpqmxpij5633cf46c10pb79-paraview-6.0.1
        # Last 25 log lines:
        # > shrinking /nix/store/s8zf2l774mpqmxpij5633cf46c10pb79-paraview-6.0.1/lib/libvtkRenderingCore.so.6.0
        # > shrinking /nix/store/s8zf2l774mpqmxpij5633cf46c10pb79-paraview-6.0.1/lib/libvtkViewsCore.so.6.0
        # > shrinking /nix/store/s8zf2l774mpqmxpij5633cf46c10pb79-paraview-6.0.1/lib/libvtkIOH5part.so.6.0
        # > shrinking /nix/store/s8zf2l774mpqmxpij5633cf46c10pb79-paraview-6.0.1/lib/libvtkjsoncpp.so.6.0
        # > shrinking /nix/store/s8zf2l774mpqmxpij5633cf46c10pb79-paraview-6.0.1/lib/libvtkCommonMisc.so.6.0
        # > shrinking /nix/store/s8zf2l774mpqmxpij5633cf46c10pb79-paraview-6.0.1/lib/libvtkIOTecplotTable.so.6.0
        # > shrinking /nix/store/s8zf2l774mpqmxpij5633cf46c10pb79-paraview-6.0.1/lib/libvtkAcceleratorsVTKmCore.so.6.0
        # > shrinking /nix/store/s8zf2l774mpqmxpij5633cf46c10pb79-paraview-6.0.1/lib/libvtkIOExport.so.6.0
        # > shrinking /nix/store/s8zf2l774mpqmxpij5633cf46c10pb79-paraview-6.0.1/lib/libvtkPVVTKExtensionsMisc.so.6.0
        # > shrinking /nix/store/s8zf2l774mpqmxpij5633cf46c10pb79-paraview-6.0.1/lib/libvtkFiltersExtraction.so.6.0
        # > shrinking /nix/store/s8zf2l774mpqmxpij5633cf46c10pb79-paraview-6.0.1/lib/libvtkRenderingVtkJS.so.6.0
        # > shrinking /nix/store/s8zf2l774mpqmxpij5633cf46c10pb79-paraview-6.0.1/lib/libvtkFiltersVerdict.so.6.0
        # > shrinking /nix/store/s8zf2l774mpqmxpij5633cf46c10pb79-paraview-6.0.1/lib/libvtkImagingColor.so.6.0
        # > shrinking /nix/store/s8zf2l774mpqmxpij5633cf46c10pb79-paraview-6.0.1/lib/libvtkioss.so.6.0
        # > shrinking /nix/store/s8zf2l774mpqmxpij5633cf46c10pb79-paraview-6.0.1/lib/libvtkCommonDataModel.so.6.0
        # > shrinking /nix/store/s8zf2l774mpqmxpij5633cf46c10pb79-paraview-6.0.1/lib/libvtklz4.so.6.0
        # > shrinking /nix/store/s8zf2l774mpqmxpij5633cf46c10pb79-paraview-6.0.1/lib/libvtkFiltersImaging.so.6.0
        # > shrinking /nix/store/s8zf2l774mpqmxpij5633cf46c10pb79-paraview-6.0.1/lib/libviskores_filter_entity_extraction-1.0.so.1.0.0
        # > shrinking /nix/store/s8zf2l774mpqmxpij5633cf46c10pb79-paraview-6.0.1/lib/libviskores_filter_flow-1.0.so.1.0.0
        # > checking for references to /nix/var/nix/builds/nix-981-954358099/ in /nix/store/s8zf2l774mpqmxpij5633cf46c10pb79-paraview-6.0.1...
        # > patching script interpreter paths in /nix/store/s8zf2l774mpqmxpij5633cf46c10pb79-paraview-6.0.1
        # > /nix/store/s8zf2l774mpqmxpij5633cf46c10pb79-paraview-6.0.1/bin/paraview-config: interpreter directive changed from "#!/usr/bin/env python3" to "/nix/store/2fq9lazlp00729g5iyxgzgsx331l5iv2-python3-3.11.13/bin/python3"
        # > stripping (with command strip and flags -S -p) in  /nix/store/s8zf2l774mpqmxpij5633cf46c10pb79-paraview-6.0.1/lib /nix/store/s8zf2l774mpqmxpij5633cf46c10pb79-paraview-6.0.1/bin
        # > Running phase: pythonRecompileBytecodePhase
        # > find: '/nix/store/s8zf2l774mpqmxpij5633cf46c10pb79-paraview-6.0.1/lib/python3.13/site-packages': No such file or directory
        # For full logs, run:
        #   nix-store -l /nix/store/3aa51qpwg2z6cvxapv961r2z1sjgd8w8-paraview-6.0.1.drv
      ...
      cmakeFlags = [
        ...
        (pkgs.lib.cmakeBool "PARAVIEW_USE_PYTHON" false) # Python fails
